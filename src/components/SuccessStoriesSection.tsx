    ...
    <section id="success-stories" className="py-24 bg-gradient-to-br from-gray-900 via-sidraPrimary to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20" data-aos="fade-up">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-8 font-sans break-words">
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white z-10">
                  <CardTitle className="text-lg sm:text-xl font-black leading-tight mb-1 text-white break-words">
                    {story.title}
                  </CardTitle>
