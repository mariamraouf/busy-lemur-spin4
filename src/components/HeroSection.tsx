  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-32 overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <img src="https://images.unsplash.com/photo-1587854692137-8cd983d87392?w=1920&h=1080&fit=crop" alt={t('modernHealthcareFacilityAlt')} className="w-full h-full object-cover" />
