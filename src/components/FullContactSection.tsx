      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="bg-white rounded-3xl p-10 shadow-2xl border border-gray-100" data-aos="fade-right" data-aos-duration="1000">
            {/* ClickUp Embed Form */}
            <iframe className="clickup-embed clickup-dynamic-height" src="https://forms.clickup.com/9012970926/f/8cke1de-20712/NWFLPJHJMEAWV2M8KE" onWheel={() => {}} width="100%" height="100%" style={{ background: 'transparent', border: '1px solid #ccc' }}></iframe>
