    ...
    <>
      ...
      <div className="pt-24 pb-16 bg-gradient-to-br from-sidraLight via-white to-gray-100 relative overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 mr-[-50px]"> {/* Grid break: shifted right */}
          ...
          <div className="space-y-24">
            {serviceCategories.map((category, index) => (
              <div
                key={index}
                className={cn(
                  "p-10 shadow-2xl border border-gray-100 bg-white",
                )}
                data-aos="fade-up"
              ...
              >
                <div className="flex items-center mb-6">
                  <div className={cn(
                    "w-20 h-20 flex items-center justify-center transform group-hover:rotate-12 transition-transform duration-300",
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6"> {/* Adjusted grid for 2 cards per row */}
                  {category.items.map((item, itemIndex) => (
                    <Card
                      key={itemIndex}
                      className="group flex flex-col items-start p-6 shadow-md border border-gray-100 transition-all duration-300 hover:shadow-lg hover:border-sidraPrimary/20 hover:scale-104"
                    >
                      <CardHeader className="p-0 mb-4 flex flex-row items-center">
                        <div className="w-12 h-12 flex items-center justify-center bg-sidraTeal/10 text-sidraTeal group-hover:bg-sidraTeal group-hover:text-white transition-all duration-300">
          ...
          <div className="text-center mt-24 py-16 bg-gradient-to-r from-sidraPrimary to-sidraSecondary shadow-2xl" data-aos="zoom-in" data-aos-delay="100">
            ...
            <Link to="/contact" className="group inline-flex items-center justify-center px-10 py-5 bg-white text-sidraPrimary font-bold hover:bg-gray-100 transition-all transform hover:scale-104 shadow-2xl text-lg">
          ...
          <div className="mt-24 py-16 bg-white shadow-2xl border border-gray-100" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 px-8">
              {approachSteps.map((step, index) => (
                <div key={index} className="text-center p-6 bg-sidraLight/50 border border-gray-100" data-aos="zoom-in" data-aos-delay={100 * (index + 1)}>
                  <div className={cn(
