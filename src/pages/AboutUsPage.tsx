        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 ml-[-100px]"> {/* Grid break: shifted left */}
          ...
          <div className="mt-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link to="/mission-vision" className="group inline-flex items-center justify-center px-8 py-4 bg-sidraPrimary text-white font-bold hover:bg-sidraSecondary transition-all transform hover:scale-104 shadow-lg">
              ...
              <Link to="/our-values" className="group inline-flex items-center justify-center px-8 py-4 bg-sidraSecondary text-white font-bold hover:bg-sidraAccent transition-all transform hover:scale-104 shadow-lg">
                <span>{t('ourValues')}</span>
                <i className={cn("fas fa-arrow-right", language === 'ar' ? 'mr-3 group-hover:-translate-x-1' : 'ml-3 group-hover:translate-x-1', "transition-transform")}></i> {/* Adjusted for RTL */}
              </Link>
              <Link to="/our-team" className="group inline-flex items-center justify-center px-8 py-4 bg-sidraTeal text-white font-bold hover:bg-sidraPrimary transition-all transform hover:scale-104 shadow-lg">
                <span>{t('ourTeam')}</span>
                <i className={cn("fas fa-arrow-right", language === 'ar' ? 'mr-3 group-hover:-translate-x-1' : 'ml-3 group-hover:translate-x-1', "transition-transform")}></i> {/* Adjusted for RTL */}
              </Link>
            </div>
