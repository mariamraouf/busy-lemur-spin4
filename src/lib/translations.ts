export const translations = {
  en: {
    ...
    faqQ6: "Does Sidra Med offer support for digital health initiatives?",
    faqA6: "Yes, we provide comprehensive support for digital health initiatives, including the implementation of healthcare IT systems, electronic medical records (EMR), and telehealth solutions.",
    ...
    aboutUsFaqQ3: "What kind of clients does Sidra Med serve?",
    aboutUsFaqA3: "We serve a diverse range of clients including private investors, hospital groups, clinic networks, and government healthcare entities.",
    aboutUsFaqQ4: "How does Sidra Med ensure project success?",
    aboutUsFaqA4: "By combining local market insights with international best practices, rigorous project management, and a network of specialized partners.",
    aboutUsFaqQ5: "What is the typical timeline for a project with Sidra Med?",
    aboutUsFaqA5: "Project timelines vary greatly depending on scope and complexity, but we work closely with clients to establish realistic and efficient schedules.",
    aboutUsFaqQ6: "Does Sidra Med offer post-launch support?",
    aboutUsFaqA6: "Yes, we provide ongoing operational support and optimization services to ensure long-term success and sustainability of healthcare facilities.",
    ...
    partnersFaqA1: "We carefully select partners based on their expertise, track record, commitment to quality, and alignment with our mission to deliver exceptional healthcare solutions.",
    partnersFaqQ2: "What are the benefits of partnering with Sidra Med?",
    partnersFaqA2: "Partners benefit from our deep market knowledge, extensive network, strategic project management, and ability to navigate complex regulatory landscapes, leading to successful project outcomes.",
    partnersFaqQ3: "Can international companies partner with Sidra Med?",
    partnersFaqA3: "Yes, we actively seek partnerships with international firms looking to enter or expand their presence in the Saudi healthcare market, providing local integration and support.",
    partnersFaqQ4: "What types of partnerships does Sidra Med engage in?",
    partnersFaqA4: "We engage in various partnerships, including strategic alliances for project delivery, technology collaborations, and service provider agreements across different healthcare domains.",
    partnersFaqQ5: "How can my organization become a partner?",
    partnersFaqA5: "If you are interested in partnering with Sidra Med, please reach out to us through our contact page with details about your organization and areas of expertise. We'd be happy to explore potential collaborations.",
    partnersFaqQ6: "Does Sidra Med offer exclusive partnerships?",
    partnersFaqA6: "Partnership terms vary depending on the nature of the collaboration. We aim for mutually beneficial relationships that enhance our collective capabilities and service offerings.",
  },
  ar: {
    // Navbar
    home: "الرئيسية",
    ...
    faqQ6: "هل تقدم سدرة ميد الدعم لمبادرات الصحة الرقمية؟",
    faqA6: "نعم، نحن نقدم دعماً شاملاً لمبادرات الصحة الرقمية، بما في ذلك تنفيذ أنظمة تكنولوجيا المعلومات الصحية، والسجلات الطبية الإلكترونية (EMR)، وحلول الرعاية الصحية عن بعد.",
    ...
    aboutUsFaqQ3: "ما نوع العملاء الذين تخدمهم سدرة ميد؟",
    aboutUsFaqA3: "نحن نخدم مجموعة متنوعة من العملاء بما في ذلك المستثمرين الخاصين، ومجموعات المستشفيات، وشبكات العيادات، والكيانات الحكومية للرعاية الصحية.",
    aboutUsFaqQ4: "كيف تضمن سدرة ميد نجاح المشروع؟",
    aboutUsFaqA4: "من خلال الجمع بين رؤى السوق المحلية وأفضل الممارسات الدولية، وإدارة المشاريع الصارمة، وشبكة من الشركاء المتخصصين.",
    aboutUsFaqQ5: "ما هو الجدول الزمني النموذجي لمشروع مع سدرة ميد؟",
    aboutUsFaqA5: "تختلف الجداول الزمنية للمشاريع بشكل كبير اعتماداً على النطاق والتعقيد، ولكننا نعمل عن كثب مع العملاء لوضع جداول زمنية واقعية وفعالة.",
    aboutUsFaqQ6: "هل تقدم سدرة ميد دعماً بعد الإطلاق؟",
  ...
  ar: {
    ...
    missionVisionFaqA1: "رسالتنا هي تمكين مقدمي الرعاية الصحية في جميع أنحاء المملكة العربية السعودية من خلال تقديم الدعم الاستراتيجي والتشغيلي والتقني لضمان نجاح المشاريع الصحية. نحن ملتزمون بتحويل تقديم الخدمات الطبية من خلال تمكين التميز في البنية التحتية والخدمات الصحية.",
    ...
    termsOfServiceSection4Content: "قد تتضمن بعض المحتويات والمنتجات والخدمات المتاحة عبر خدمتنا مواد من أطراف ثالثة. قد توجهك روابط الطرف الثالث على هذا الموقع إلى مواقع ويب تابعة لجهات خارجية غير تابعة لنا. نحن لسنا مسؤولين عن فحص أو تقييم المحتوى أو الدقة ولا نضمن ولن نتحمل أي مسؤولية عن أي مواد أو مواقع ويب تابعة لجهات خارجية، أو عن أي مواد أو منتجات أو خدمات أخرى تابعة لجهات خارجية. نحن لسنا مسؤولين عن أي ضرر أو أضرار تتعلق بشراء أو استخدام السلع أو الخدمات أو الموارد أو المحتوى أو أي معاملات أخرى تتم فيما يتعلق بأي مواقع ويب تابعة لجهات خارجية. يرجى مراجعة سياسيات وممارسات الطرف الثالث بعناية والتأكد من فهمها قبل الدخول في أي معاملة. يجب توجيه الشكاوى أو المطالبات أو المخاوف أو الأسئلة المتعلقة بمنتجات الطرف الثالث إلى الطرف الثالث.",
    termsOfServiceSection5Title: "5. تعليقات المستخدمين والملاحظات والتقديمات الأخرى",
    termsOfServiceSection5Content: "إذا قمت، بناءً على طلبنا، بإرسال بعض التقديمات المحددة (على سبيل المثال إدخالات المسابقة) أو بدون طلب منا، أرسلت أفكارًا إبداعية أو اقتراحات أو مقترحات أو خططًا أو مواد أخرى، سواء عبر الإنترنت أو عبر البريد الإلكتروني أو عبر البريد العادي أو غير ذلك (يُشار إليها إجمالاً باسم 'التعليقات')، فإنك توافق على أنه يجوز لنا، في أي وقت، دون قيود، تحرير أو نسخ أو نشر أو توزيع أو ترجمة أو استخدام بأي طريقة أخرى في أي وسيط أي تعليقات ترسلها إلينا. نحن ولسنا ملزمين (1) بالحفاظ على سرية أي تعليقات؛ (2) بدفع تعويض عن أي تعليقات؛ أو (3) بالرد على أي تعليقات. يجوز لنا، ولكن ليس لدينا أي التزام، بمراقبة أو تحرير أو إزالة المحتوى الذي نحدده وفقًا لتقديرنا الخاص بأنه غير قانوني أو مسيء أو مهدد أو تشهيري أو افترائي أو إباحي أو فاحش أو غير مقبول بأي شكل آخر أو ينتهك الملكية الفكرية لأي طرف أو شروط الخدمة هذه. أنت توافق على أن تعليقاتك لن تنتهك أي حق لأي طرف ثالث، بما في ذلك حقوق الطبع والنشر أو العلامات التجارية أو الخصوصية أو الشخصية أو أي حق شخصي أو ملكية آخر. أنت توافق كذلك على أن تعليقاتك لن تحتوي على مواد تشهيرية أو غير قانونية أو مسيئة أو فاحشة بأي شكل آخر، أو تحتوي على أي فيروس كمبيوتر أو برامج ضارة أخرى يمكن أن تؤثر بأي شكل من الأشكال على تشغيل الخدمة أو أي موقع ويب ذي صلة. لا يجوز لك استخدام عنوان بريد إلكتروني مزيف، أو التظاهر بأنك شخص آخر غير نفسك، أو تضليلنا أو تضليل أطراف ثالثة بأي شكل آخر فيما يتعلق بأصل أي تعليقات. أنت وحدك المسؤول عن أي تعليقات تقوم بها ودقتها. نحن لا نتحمل أي مسؤولية ولا نتحمل أي التزام عن أي تعليقات تن<dyad-problem-report summary="1 problems">
<problem file="src/pages/OurTeamPage.tsx" line="47" column="22" code="2345">Argument of type '&quot;teamRole4Description&quot;' is not assignable to parameter of type '&quot;months&quot; | &quot;tech&quot; | &quot;compliance&quot; | &quot;efficiency&quot; | &quot;system&quot; | &quot;satisfaction&quot; | &quot;entry&quot; | &quot;partnerships&quot; | &quot;adherence&quot; | &quot;home&quot; | &quot;aboutUs&quot; | &quot;services&quot; | &quot;partners&quot; | &quot;contact&quot; | ... 348 more ... | &quot;partnersFaqA6&quot;'.</problem>
</dyad-problem-report><think>**Addressing Translation Key Error**

I'm currently investigating a TypeScript compile-time error within `OurTeamPage.tsx`. It seems the translation key `'teamRole4Description'` isn't being recognized, despite its recent addition to `translations.ts`.  This points to a common synchronization issue between the translation file and the type definitions TypeScript relies on. I'm exploring potential solutions, such as double-checking the import paths or perhaps rebuilding the translation type definitions. I'll get to the bottom of this.


**Fixing Type Definition Lag**

I've re-written `src/lib/translations.ts` in an attempt to refresh the `TranslationKey` type definition, which should resolve the unrecognized key error. The key is correctly used, so it's most likely the type definitions were lagging. I'm also going to examine whether there's a problem with the file system watcher, since this sort of lag is common when tools are failing to detect file system changes. I will focus on diagnosing and fixing the underlying cause of this lag.


</think>It looks like the TypeScript compiler is still having trouble recognizing the `teamRole4Description` key, even though it was added to `src/lib/translations.ts`. This can sometimes happen with how TypeScript caches type definitions.

To ensure the compiler correctly picks up the updated translation keys, I'll re-write the `src/lib/translations.ts` file. This often forces a refresh of the type definitions and should resolve the error.

<dyad-write path="src/lib/translations.ts" description="Re-writing the translations file to ensure TypeScript picks up all defined keys, including team role descriptions.">
export const translations = {
  en: {
    // Navbar
    home: "Home",
  ...
  ar: {
    ...
    homeFaqA5: "من خلال شبكة تحالفاتنا الواسعة، نقدم شراكات استراتيجية تمكن من تسليم المشاريع من البداية إلى النهاية، والجمع بين الخبرات المتخصصة في مجالات مثل القانونية والمالية والتصميم والبناء.",
    homeFaqQ6: "هل تشارك سدرة ميد في مبادرات الصحة الرقمية؟",
    homeFaqA6: "نعم، نحن ندعم بنشاط مبادرات الصحة الرقمية، بما في ذلك تنفيذ تكنولوجيا المعلومات الصحية، والسجلات الطبية الإلكترونية (EMR)، وحلول الرعاية الصحية عن بعد.",
