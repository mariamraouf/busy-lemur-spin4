export const translations = {
  ...
  ar: {
    ...
    partnersFaqA3: "نعم، نسعى بنشاط إلى الشراكة مع الشركات الدولية التي تتطلع إلى دخول أو توسيع وجودها في سوق الرعاية الصحية السعودي، وتقديم التكامل والدعم المحلي.",
